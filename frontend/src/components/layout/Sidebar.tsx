...
export function Sidebar() {
  ...
  const { headerName, logoUrl } = useBranding();
  ...
  return (
    ...
    >
      ...
      <div className={`p-6 flex items-center ${isHovered ? "gap-3" : "justify-center"}`}>
        <div className="bg-primary/10 p-2 rounded-lg text-primary shrink-0 overflow-hidden">
          {logoUrl ? (
            <img src={logoUrl} alt={headerName} className="h-6 w-6 object-contain" />
          ) : (
